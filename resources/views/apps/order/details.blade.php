  ...
  <div class="container">
      <div class="row">
        <div class="cart-table">
          <div class="cart-body order-page">                       
          <div class="each-order">
            ...
            <div class="cart-list-product">
              <div class="pro-img">
                <img class="img-fluid" src="https://grofie.in/{{$order->product_image_main}}" alt="">
              </div>
              <div class="pro-desc">
...
$(document).ready(function(){
  $(document).on('click' ,'.cancel',function(event){
    ...
    success:function(data){
      ...
      {
        $("#cover-spin").hide();
        $(".each-order").load(window.location + " .each-order");  
      }
    },
    });
  });

      ...
      <div class="row">
         <div class="cart-table">
            ...
            <div class="cart-list-product">
              ...
              <div class="pro-img"><img class="img-fluid" src="https://grofie.in/{{$cart->product_image_main}}" alt=""></div>
              <div class="pro-desc">
              ...
              <div class="cart-list-product">
              <a  class="del float-right remove-cart" data-url="{{route('apps.cart.del',$cart->cart_id)}}"><i class="mdi mdi-close"></i></a>
              <div class="pro-img not-aviable"><img class="img-fluid" src="https://grofie.in/{{$cart->product_image_main}}" alt=""></div>
...
$(document).ready(function(){
  $(document).on('click' ,'.del',function(event){
    ...
    success:function(data){
      if(data.delete)
      {        
        $(".cart-page").load(window.location + " .cart-page");  
